...
def avro_to_s3(name_table: str, data: List[Dict[str, Any]], s3: Any, s3_bucket_name: str,s3_prefix_backup: str) -> None:
    ...
    s3.Object(s3_bucket_name, f"{s3_prefix_backup}/{today}/{name_table}_table.avro").put(Body=avro_bytes.getvalue())
...
if __name__ == "__main__":
    ...
    #connect to aws   
    s3,_=functions.connect_aws(functions.aws_access_key_id,functions.aws_secret_access_key,functions.aws_region_name)
    ...
    for name_table in functions.list_name_table:
        ...
        #upload s3
        avro_to_s3(name_table,data,s3,functions.s3_bucket_name,functions.s3_prefix_backup)
