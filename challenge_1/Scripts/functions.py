...
def connect_aws(aws_access_key_id: str, aws_secret_access_key: str,
                aws_region_name: str) -> Optional[boto3.resources.base.ServiceResource]:
    """
...
def connect_bd(user: str, password: str, host: str, port: int,
               db: str) -> Optional[pymysql.connections.Connection]:
    """
...
def create_avro_schema(
        name_table: str) -> Dict[str, Union[str, list, Dict[str, Union[str, int]]]]:
    """
